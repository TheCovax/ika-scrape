...
from gui import login_layout, create_main_layout, set_loggedIn
...
main_layout = create_main_layout(trade_goods, miracles, xcoord_max, xcoord_min, ycoord_max, ycoord_min, citymax, citymin, toggle_btn_off)
